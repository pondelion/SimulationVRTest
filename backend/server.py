...
financial_reduced3 = TSNE(n_components=3).fit_transform(df_financial_latest[target_cols])
financial_reduced3 /= financial_reduced3.flatten().max()
financial_reduced2 = TSNE(n_components=2).fit_transform(df_financial_latest[target_cols])
...
@app.get('/financial_distdata/{dim}')
